...
<div class="row " style="margin-bottom:20px;">
    ...
    <div class="form-group">
      ...
      <div class='input-group date' id='datetimepicker1'>
                    <input name="datedebut" type='text' class="form-control datepicker" id="datepicker" placeholder="Date Debut" />
                ...
                <div class='input-group date' id='datetimepicker2'>
                    <input name="datefin" type='text' class="form-control datepicker" id="datepicker1" placeholder="Date Fin" />
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
    ...
    <div class="btn-group" data-toggle="buttons">
	  <label class="btn btn-primary options">
	    <input  type="radio" name="option1" id="option1"> Aujourd'hui
	  </label>
	  <label class="btn btn-primary options">
	    <input  type="radio" name="option2" id="option2"> Cette semaine
	  </label>
	  <label class="btn btn-primary options">
	    <input  type="radio" name="option3" id="option3"> Ce mois
	  </label>
	  <label class="btn btn-primary options">
	    <input  type="radio" name="option4" id="option4"> Cette année
	  </label>
	</div>
		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						<div class="pull-left">
							<h3 class="widget-title text-primary"><span class="counter" data-plugin="counterUp" id="prospects">{{ $prospects->count() }}</span></h3>
							<small class="text-color">Prospects</small>
						</div>
			...
			<div class="col-md-3 col-sm-6">
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						<div class="pull-left">
							<h3 class="widget-title text-danger"><span class="counter" data-plugin="counterUp" id="leads">{{ $leads }}</span></h3>
							<small class="text-color">Leads</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-file-text"></i></span>
					</div>
			...
			<div class="col-md-3 col-sm-6">
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						<div class="pull-left">
							<h3 class="widget-title text-success"><span class="counter" data-plugin="counterUp" id="messages">{{ $messages->count() }}</span></h3>
			...
			<div class="col-md-3 col-sm-6">
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						<div class="pull-left">
							<h3 class="widget-title text-warning"><span class="counter" data-plugin="counterUp" id="produits">{{ $produits->count() }}</span></h3>
							<small class="text-color">Produit</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-product-hunt"></i></span>
					</div>
...
{{ Html::script('back-end/highcharts/js/highcharts.js') }}
{{ Html::script('back-end/highcharts/js/modules/exporting.js') }}
...
<script>
	...
	$(function () {
        ...
        $('.options').click(function(){
            ...
            var option = $(this).find('input').attr('id');
            var token = $('#token').val();

            $.post("{{ url('statistique') }}", {option:option, _token:token}, function (donnee) {

            	console.log(donnee);
                
             	$('#prospects').text(donnee.prospects);
			    $('#messages').text(donnee.messages);
			    $('#produits').text(donnee.produits);
                $('#leads').text(donnee.leads);
                
                var ficheParProduit = $.parseJSON(donnee.statLeadsByProduct);

                     
                    var arrayFicheParProduit = [];

                     $.each(ficheParProduit, function(key, val){
                         arrayFicheParProduit.push([key, val]);
                     });
                  
                  fonctionFicheParProduit(arrayFicheParProduit);
                  statistiqueDept();
		...
		//$(".datepicker").mask("9999-99-99");
		 ...
		 $('.search').click(function(){
             ...
             $.post("{{ url('statistique') }}", $('#form').serialize(), function (donnee) {
...
function fonctionFicheParProduit(donnee) {
	$('#container1').highcharts({
				        chart: {
				            type: 'column'
				        },
				        title: {
				            text: 'Statistique des leads par produits'
				        },
				        subtitle: {
				            text: ''
				        },
				        ...
				        tooltip: {
				            pointFormat: 'Nombre de fiche: <b>{point.y} unité(s)</b>'
				        },
				        series: [{
				            name: 'Population',
				            data: donnee,
