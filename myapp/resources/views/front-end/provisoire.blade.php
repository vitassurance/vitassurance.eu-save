...
@section('content')
{!! Form::open([
    'action' => 'ProvisoireController@insertion','files' => true
]) !!}
<br>
<div class="container">
	<div class="row">
	...
	<div class="row">
		<div class="col-md-12">
			<h2><i class="fa {{$produit->icon}}" aria-hidden="true"></i>  {{$produit->titre}}</h2>
		</div>
		<input type="text"  hidden value="{{$produit->id}}" id="idProduit" name="idProduit"></input>
	</div>
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body" style="background-color: #f5f5f5;">
			    <div class="row">
			     ...
			     <h6 class="" style="margin-left:35px">Produit </h6>
			     </div>
			    	<div class="form-group">
						       
						        <div class="col-lg-7">
						           <input type="text" class="form-control uk-margin-bottom" name="dateEffet" id="dateEffet" value="{{$produit->id}}" >
			      	...
			      	<div class="col-md-6 infos">
						  ...
						  <fieldset>
						    ...
						    <div class="col-lg-5" align="right">
							    ...
							    <div class="col-lg-7">
							        <input type="text" class="form-control uk-margin-bottom" id="nom" name="nom" value="{{ old('nom') }}" >
									@if ($errors->has('nom'))
						   ...
						   <div class="col-lg-5" align="right">
							    ...
							    <div class="col-lg-7">
							        <input type="text" class="form-control uk-margin-bottom" id="prenom" name="prenom" value="{{ old('prenom') }}">
							    @if ($errors->has('prenom'))
                                    <span class="help-block">
							...
							<div class="col-lg-5" align="right">
						        ...
						        <div class="col-lg-7">
						            <select class="form-control uk-margin-bottom" name="ville" id="ville" value="{{ old('ville') }}" >
						            <option value=""></option>
						    ...
						    <div class="col-lg-5" align="right">
							    ...
							    <div class="col-lg-7">
							        <input type="text" class="form-control uk-margin-bottom" id="email" name="email" value="{{ old('email') }}" >
							     @if ($errors->has('email'))
                                    <span class="help-block">
							...
							<div class="form-group">
						    <div class="col-lg-5" align="right">
							    <label class="control-label">Email professionnel</label>
							    </div>
							    <div class="col-lg-7">
							        <input type="text" class="form-control uk-margin-bottom" id="emailPro" name="emailPro" value="{{ old('emailPro') }}" d>
							...
							<div class="col-lg-5" align="right">
							    ...
							    <div class="col-lg-7">
							        <input type="text" class="form-control uk-margin-bottom" id="mobile" name="mobile" value="{{ old('mobile') }}">
						    ...
						    @endif
							<div class="col-lg-5" align="right">
							    <label class="control-label ">Date d'effet de mon contrat</label>
							    </div>
							    <div class="col-lg-7" id='datetimepicker1'>
                   <input name="dateEffet" type='text' class="form-control datepicker" id="dateEffet" placeholder="Date debut contrat" value="{{ old('dateEffet') }}" />
			      	...
			      	<div class="col-md-6 infos">
			      		 <fieldset>
			      		 	...
			      		 	@if ($errors->has('situationMatrimoniale'))
						    <div class="form-group has-error" >
						    @else
						    <div class="form-group" >
						    @endif
							<div class="col-lg-5" align="right">
						        ...
						        <div class="col-lg-7">
						        	<select class="form-control uk-margin-bottom" name="situationMatrimoniale" id="situationMatrimoniale" value="{{ old('situationMatrimoniale') }}" >
                        ...
                        <option value="{{$matrimoniale->id}}">{{$matrimoniale->libelle}}</option>
						        	...
						        	@if ($errors->has('situationMatrimoniale'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('situationMatrimoniale') }}</strong>
                                    </span>
                                @endif
						        </div>
						    </div>
                        ...
                        <option value="{{$profession->id}}">{{$profession->libelle}}</option>
                            ...
                            @if($produit->titre == 'emprunteur')
                            <div class="on form-group" id="montantEmprunteurId">
                             <div class="col-md-5" align="right">
                                <label class="control-label " >Montant emprunteur : </label>
                                </div>
                                <div class="col-md-7">
                                   <input type="text" class="form-control uk-margin-bottom" name="montantEmprunteur" id="montantEmprunteur" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="TauxId">
                             <div class="col-md-5" align="right">
                                <label class="control-label " >Taux : </label>
                                </div>
                                <div class="col-md-7">
                                   <input type="text" class="form-control uk-margin-bottom" name="taux" id="taux" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="dureeId">
                             <div class="col-md-5" align="right">
                                <label class="control-label " >Durée : </label>
                                </div>
                                <div class="col-md-7">
                                   <input type="text" class="form-control uk-margin-bottom" name="duree" id="duree" value="" >
                                </div>
                            </div>
                            @endif
                            @if($produit->titre == 'retraite')
                            <div class="on form-group" id="revenuProfessionnelActiviteId">
                             <div class="col-md-7" align="right">
                                <label class="control-label " >Revenu professionnel/d'activité : </label>
                                </div>
                                <div class="col-md-5">
                                   <input type="text" class="form-control uk-margin-bottom" name="revenuProfessionnelActivite" id="revenuProfessionnelActivite" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="capaciteEpargneId">
                             <div class="col-md-7" align="right">
                                <label class="control-label " >capacité d'épargne : </label>
                                </div>
                                <div class="col-md-5">
                                   <input type="text" class="form-control uk-margin-bottom" name="capaciteEpargne" id="capaciteEpargne" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="montantSouhaiteRetraiteId">
                             <div class="col-md-7" align="right">
                                <label class="control-label " >montant souhaité à la retraite : </label>
                                </div>
                                <div class="col-md-5">
                                   <input type="text" class="form-control uk-margin-bottom" name="montantSouhaiteRetraite" id="montantSouhaiteRetraite" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="projetId">
                             <div class="col-lg-5" align="right">
                                <label class="control-label " >Projet :</label>
                                </div>
                                <div class="col-lg-7">
                                   <select class="form-control uk-margin-bottom" name="projet" id="projet" >
                                    <option selected="selected" value="">Sélectionner</option>
                            ...
                            <div class="on form-group" id="horizonProjetId">
                             <div class="col-md-7" align="right">
                                <label class="control-label " >horizon du projet : </label>
                                </div>
                                <div class="col-md-5">
                                   <input type="text" class="form-control uk-margin-bottom" name="horizonProjet" id="horizonProjet" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="projetId">
                             <div class="col-lg-5" align="right">
                            ...
                            @endif
                            @if($produit->titre == 'responsabilité civile')
                            <div class="on form-group" id="formeExploitationId">
                             <div class="col-md-7" align="right">
                                <label class="control-label " >Forme d'exploitation : </label>
                                </div>
                                <div class="col-md-5">
                                   <input type="text" class="form-control uk-margin-bottom" name="formeExploitation" id="formeExploitation" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="chiffreAffaireId">
                             <div class="col-md-7" align="right">
                                <label class="control-label " >chiffre d'affaire : </label>
                                </div>
                                <div class="col-md-5">
                                   <input type="text" class="form-control uk-margin-bottom" name="chiffreAffaire" id="chiffreAffaire" value="" >
                                </div>
                            </div>
                            @endif
                             @if($produit->titre == 'decenale')
                             <div class="on form-group" id="revenuProfessionnelActiviteId">
                             <div class="col-md-7" align="right">
                                <label class="control-label " >Revenu professionnel/d'activité : </label>
                                </div>
                                <div class="col-md-5">
                                   <input type="text" class="form-control uk-margin-bottom" name="revenuProfessionnelActivite" id="revenuProfessionnelActiviteDecenale" value="" >
                                </div>
                            </div>
                            <div class="on form-group" id="formeExploitationId">
                             <div class="col-md-7" align="right">
